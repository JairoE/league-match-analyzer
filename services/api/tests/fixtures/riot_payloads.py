...
def load_account_info() -> dict[str, Any]:
    return _read_json(_fixture_path("account_info_file"))


def load_summoner_info() -> dict[str, Any]:
    return _read_json(_fixture_path("summoner_info_file"))


def load_match_ids() -> list[str]:
    payload = _read_json(_fixture_path("match_ids_file"))
...
def load_match_detail() -> dict[str, Any]:
    return _read_json(_fixture_path("match_detail_file"))


def load_match_timeline() -> dict[str, Any]:
    return _read_json(_fixture_path("match_timeline_file"))

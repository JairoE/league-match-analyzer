...
@pytest.mark.asyncio
async def test_riot_client_retries_5xx_then_succeeds(monkeypatch: pytest.MonkeyPatch) -> None:
...
@pytest.mark.asyncio
async def test_riot_client_retries_network_then_raises(monkeypatch: pytest.MonkeyPatch) -> None:
